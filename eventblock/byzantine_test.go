...
func byzantineDecideProposalFunc(t *testing.T, height int64, round int, cs *ConsensusState, sw *p2p.Switch) {
	...
	polRound, propBlockID := cs.ValidRound, EventBlockID{block1.Hash(), blockParts1.Header()}
	...
	polRound, propBlockID = cs.ValidRound, EventBlockID{block2.Hash(), blockParts2.Header()}
