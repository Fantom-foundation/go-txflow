...
func (bs *BlockStore) LoadBlockPart(height int64, index int) *ttypes.Part {
	var part = new(ttypes.Part)
...
func (bs *BlockStore) LoadBlockMeta(height int64) *ttypes.BlockMeta {
	var blockMeta = new(ttypes.BlockMeta)
...
func (bs *BlockStore) LoadBlockCommit(height int64) *ttypes.Commit {
	var commit = new(ttypes.Commit)
...
func (bs *BlockStore) LoadSeenCommit(height int64) *ttypes.Commit {
	var commit = new(ttypes.Commit)
...
func (bs *BlockStore) SaveBlock(block *types.Block, blockParts *ttypes.PartSet, seenCommit *ttypes.Commit) {
	if block == nil {
	...
	// Save block meta
	blockMeta := ttypes.NewBlockMeta(block.GetTendermintBlock(), blockParts)
...
func (bs *BlockStore) saveBlockPart(height int64, index int, part *ttypes.Part) {
