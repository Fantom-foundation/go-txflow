...
var (
	ErrInvalidTxSignature = errors.New("Error invalid tx signature")
	ErrAddingTx           = errors.New("Error adding tx")
)
...
type TxDAGState struct {
	...
	// store tx and commits
	txStore sm.TxStore

	// create and execute signed transactions
	txExec *sm.TxExecutor
	...
	// information about about added votes and tx are written on this channel
	...
	decideTx func()
	setTx    func(proposal *types.Proposal) error
